        ...
        <div class="navbar" style="display: flex;justify-content: space-between">
            ...
            <div class="navbar-right-container" style="display: flex">
                <div class="navbar-menu-container">
                    ...
                    <span class="navbar-link" v-if="nickName" style="color: #f40;">{{'Hello,'+nickName}}</span>
                    <a href="javascript:void(0)" class="navbar-link" v-if="!nickName"
                       @click="loginModalFlag=true">Login</a>
                    ...
                    <div class="confirm-tips">
                        ...
                        <ul>
                            <li class="regi_form_input">
                                ...
                                <input type="text" tabindex="1" v-model="userName" name="loginname"
                                       class="regi_login_input regi_login_input_left" placeholder="User Name"
                                       data-type="loginname">
                            </li>
                            <li class="regi_form_input noMargin">
                                <i class="icon IconPwd"></i>
                                <input type="password" tabindex="2" v-model="userPwd" name="password"
