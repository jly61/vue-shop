<template>
    <div>
                                ...
                                <div class="cart-tab-1">
                                    <div class="cart-item-check">
                                        <a href="javascipt:;" class="checkbox-btn item-check-btn"
                                           :class="{'check':item.checked === true}" @click="editCart('checked',item)">
                                    ...
                                    <div class="cart-item-pic">
                                        <img :src=" '/static/'+ item.productImage" :title="item.productName">
                                    </div>
                                    ...
                                    <div class="item-quantity">
                                        <div class="select-self select-self-open">
                                            <div class="select-self-area">
                                                <a class="input-sub" @click="editCart('cut',item)">-</a>
        ...
        <modal :mdShow="confirmModal" @close="closeModal">
            <p slot="message">确认删除?</p>
            <div slot="btnGroup">
                <a class="btn btn--m" href="javascript:;" @click="delCart">确认</a>
                <a class="btn btn--m" href="javascript:;" @click="confirmModal = false">取消</a>
            </div>
        </modal>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //删除购物车
            delCart() {
                axios.post('/users/cart/del', {productId: this.delItem.productId}).then((res) => {
            ...
            editCart(flag, item) {
                ...
                //可优化，减少不必要的查询
                axios.post('/users/cartEdit', {productId: item.productId, productNum: item.productNum, checked: item.checked}).then((res) => {
                    let num = 0;
                    if(flag === 'cut') {
                        num = -1;
                    } else if(flag === 'add') {
