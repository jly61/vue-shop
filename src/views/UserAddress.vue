            ...
            <div class="container">
                <div class="checkout-addr">
                    ...
                    <div class="addr-list-wrap">
                        <div class="addr-list">
                            <ul>
                                <li v-for="(item,index) in addressListFilter" :class="{'check':checkIndex === index}" @click="checkIndex = index;checkedAddressId=item.addressId">
                                    <dl>
                                        <dt>{{item.userName}}</dt>
                        ...
                        <modal :mdShow="addressModalFlag" @close="closeModal">
                            <p slot="message">
                                确认删除该地址？
                            </p>
                            <div slot="btnGroup">
                                <a class="btn btn--m" href="javascript:;" @click="delAddress">确认</a>
                                <a class="btn btn--m" href="javascript:;" @click="addressModalFlag=false">取消</a>
                            </div>
                        </modal>
                    ...
                    <div class="next-btn-wrap">
                        <router-link class="btn btn--m btn--red" :to="{name:'OrderConfirm', query: {addressId: checkedAddressId}}">Next</router-link>
                    </div>
                </div>
            </div>
        </div>
